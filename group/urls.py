...
def call_router(app):
    ...
    app.route('/groups/<id>', 'DELETE', group.delete, apply=[check_auth, inject_db,timeit])
    ...
    app.route('/group-users/<id>', 'DELETE', group_user.delete, apply=[check_auth, inject_db,timeit])

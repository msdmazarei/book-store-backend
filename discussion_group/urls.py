...
def call_router(app):
    ...
    app.route('/discussion-groups/<id>', 'DELETE', discussuion_group.delete, apply=[check_auth, inject_db,timeit])
    ...
    app.route('/group-members/remove-members/<group_id>', 'POST', discussion_group_member.delete_group_members, apply=[check_auth, inject_db,timeit])
    app.route('/group-members/<id>', 'DELETE', discussion_group_member.delete, apply=[check_auth, inject_db,timeit])

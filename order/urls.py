...
def call_router(app):
    ...
    app.route('/orders/<id>', 'DELETE', order.delete, apply=[check_auth, inject_db,timeit])
    ...
    app.route('/order-items/<id>', 'DELETE', order_items.delete, apply=[check_auth, inject_db,timeit])

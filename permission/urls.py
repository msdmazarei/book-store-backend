...
def call_router(app):
    ...
    app.route('/permissions/<id>', 'DELETE', delete, apply=[check_auth, inject_db,timeit])
    ...
    app.route('/group-permissions/<id>', 'DELETE', group_permission.delete, apply=[check_auth, inject_db,timeit])

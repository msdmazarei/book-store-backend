class Message:
    ...
    BUYER_CELL_NO_ERROR = 'buyer_cell_no_error'
    MINIMUM_PAYMENT_ERROR = 'minimum_payment_error'
    MAXIMUM_PAYMENT_ERROR = 'maximum_payment_error'
    PAYMENT_SERIAL_ERROR = 'payment_serial_error'
